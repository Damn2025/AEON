...
const EvokeDifference = () => {
  ...
  const differenceData = {
    ...
    powerUps: {
      ...
      description:
        'Expand capabilities and automate complex workflows with Power-Ups—perfect for scaling digital operations. Customize AEON to match your unique business needs.',
    },
  };
